...
import QtQuick 2.0
import "js/QwertyControl2.js" as QControl
...
Rectangle {
    ...
    Rectangle{
        ...
        Grid{
            ...
            Rectangle{
                ...
                color: "green"
                Image{
                    id: languageSettingsImg
                    anchors.fill: parent
                    source: "images/felix/LanguagePanel.jpg"
                }
                MouseArea{
                    anchors.fill: parent
                    onClicked: {
                        languageSettingsImg.source = "images/felix/LanguagePanel2.jpg"
                    }
                }
                    ...
                    Rectangle{
                        ...
                        MouseArea{
                            ...
                            onClicked: {
                                ...
                                miscSett1.visible=false;
                                miscSett2.visible=false;
                            }
                        }
                    }//end location input
                    ...
                    Rectangle{
                        ...
                        Grid{
                            ...
                            Rectangle{
                                ...
                                Image{
                                    anchors.fill:parent
                                    source: "images/felix/EditButton.jpg"
                                }
                            }
                            //Mobile Access
                            Rectangle{
                            ...
                            Rectangle{
                                ...
                                height:50
                                Text{
                                    id: additionalSettText
                                    anchors.centerIn: parent
                                    font.pointSize: 20
                                    font.family: "Calibri"
                                    text: "Add Another Setting"
                                }
                            }
                        ...
                        }//endMisc settings grid


                    }
                }//end location Grid
               }//end column2
            //linked accounts column 3
            Rectangle{
                id: linkedSettings
                width: 280
                height: 656
    ...
    Rectangle{
        ...
        Image{
            id:view2Image
            source: "images/felix/UserMarge2.jpg"
            MouseArea{
                anchors.fill: parent
                onPressed:{
                    view1.visible=true;
